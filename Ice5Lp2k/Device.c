    ...
    )
{
    ...
    // Limit access later to system and admin for security :D
...
#else
    DECLARE_CONST_UNICODE_STRING(LOCAL_SDDL_DEVOBJ_SYS_ALL, L"D:P(A;;GA;;;SY)");
#endif

    status = WdfDeviceInitAssignSDDLString(
        DeviceInit,
#ifdef _DEBUG
        &LOCAL_SDDL_DEVOBJ_SYS_ALL_ADM_ALL
#else
        &LOCAL_SDDL_DEVOBJ_SYS_ALL
#endif
    );
